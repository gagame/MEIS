...
function check(){
    ...
    else location.href="memory?"+getPara[0].replace(text1+text2,"");
...
function toMemory(){
    location.href="memory?BROADCAST=a"+String.fromCharCode(getRandom(48,57))+"b"+String.fromCharCode(getRandom(48,57))+"c"+String.fromCharCode(getRandom(48,57))+"d"+String.fromCharCode(getRandom(48,57))+"e"+String.fromCharCode(getRandom(48,57));//ascii 48~57 = char 0~9
